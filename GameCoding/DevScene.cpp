...
void DevScene::Update()
{
	...
	{
		GET_SINGLE(ResourceManager)->SaveTilemap(L"Tilemap_01", L"C:\\Users\\IUBOO\\Desktop\\Tilemap\\Tilemap_01.txt");
	}
	else if (GET_SINGLE(InputManager)->GetButtonDown(KeyType::E))
	{
		GET_SINGLE(ResourceManager)->LoadTilemap(L"Tilemap_01", L"C:\\Users\\IUBOO\\Desktop\\Tilemap\\Tilemap_01.txt");	
	}
}
